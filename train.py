...
if __name__ == "__main__":
    ...
    if True:
        ...
        for epoch in range(Init_Epoch,Freeze_Epoch):
            # TODO
            loss, waste_time = fit_ont_epoch(net,yolo_losses,epoch,epoch_size,epoch_size_val,gen,gen_val,Freeze_Epoch,Cuda)
            writer.add_scalar('loss', loss, global_step=epoch)
            writer.add_scalar('waste_time', waste_time, global_step=epoch)
            lr_scheduler.step()
    ...
    if True:
        ...
        for epoch in range(Freeze_Epoch,Unfreeze_Epoch):
            # TODO
            loss, waste_time = fit_ont_epoch(net,yolo_losses,epoch,epoch_size,epoch_size_val,gen,gen_val,Unfreeze_Epoch,Cuda)
            writer.add_scalar('loss', loss, global_step=epoch)
